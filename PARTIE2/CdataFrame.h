...
void nb_cellule_egale(CDATAFRAME* cdf, ENUM_TYPE* list_type);
void nb_cellule_sup(CDATAFRAME* cdf, ENUM_TYPE* list_type);
void nb_cellule_inf(CDATAFRAME* cdf, ENUM_TYPE* list_type);
